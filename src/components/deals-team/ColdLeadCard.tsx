...
export function ColdLeadCard({ contact, teamId, onClick }: ColdLeadCardProps) {
  ...
  return (
    <>
      <Card className="border-l-4 border-l-slate-400 hover:shadow-md transition-shadow cursor-pointer" onClick={onClick}>
