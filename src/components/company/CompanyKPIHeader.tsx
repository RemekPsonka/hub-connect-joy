...
import { 
  Building, Globe, MapPin, Pencil, Calendar,
  Target, Database, CheckCircle, AlertTriangle
} from 'lucide-react';
...
export function CompanyKPIHeader({ company, ownerContactId }: CompanyKPIHeaderProps) {
